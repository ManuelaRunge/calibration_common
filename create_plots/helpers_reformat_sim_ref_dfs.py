...
def get_fraction_in_infectious_bin(sim_df):
    ...
    sim_df_group_total = sim_df_agg1.groupby(['Site', 'month', 'Run_Number', 'agebin']).agg(
    ...
    sim_df_agg1 = pd.merge(sim_df_agg1, sim_df_group_total, on=['Site', 'month', 'Run_Number', 'agebin'],
                    how='outer')
